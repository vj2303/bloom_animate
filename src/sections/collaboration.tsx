...
export const Collaboration = () => {
  ...
  return (
    <section
      ref={targetRef}
      className="relative z-10 mt-[-30vh] h-[300vh] sm:mt-[-20vh] sm:h-[200vh]"
    >
      <div
        ref={extendedRef}
        className="mb-[-120vh] h-[420vh] w-full sm:mb-[-60vh] sm:h-[300vh]"
      >
          ...
          <div className="flex justify-center px-4 sm:px-2">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute right-[10%] top-[1.5%] flex gap-2 sm:gap-1"
              >
                <motion.img
                  style={{ scale: avatarOneScale }}
                  className="h-[1.5vw] w-[1.5vw] sm:h-6 sm:w-6 rounded-full border border-[#4ca] object-cover"
                ...
                <motion.img
                  ...
                  className="h-[1.5vw] w-[1.5vw] sm:h-6 sm:w-6 rounded-full border border-[#c82] object-cover"
                  src="https://unsplash.com/photos/sibVwORYqs0/download?force=true&w=128&h=128"
                />
                <motion.img
                  style={{ scale: avatarThreeScale }}
                  className="h-[1.5vw] w-[1.5vw] sm:h-6 sm:w-6 rounded-full border border-[#f0f] object-cover"
