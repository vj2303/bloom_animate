      ...
      <div className="relative h-[800vh]">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            ...
            />
            <motion.span
              className="mt-3 block sm:text-2xl text-xl text-white"
              style={{ opacity: newBranchOpacity }}
            >
              <BranchIcon className="mr-3 inline-block sm:h-12 sm:w-12 h-8 w-8" /> Growth Journey
          ...
          >
            ...
            >
              <img src="/img4.jpg" className="h-auto w-full rounded-md" />
            </motion.div>
            <motion.span
              className="mt-3 block sm:text-2xl text-xl text-white"
              style={{ opacity: newBranchOpacity }}
            >
              <BranchIcon className="mr-3 inline-block sm:h-12 sm:w-12 h-8 w-8" /> Bloomscroll
              
            </motion.span>
          </motion.div>

          <motion.p
            className="translate-y-centered-offset absolute top-1/2 left-[calc(50%-60rem)] w-[50rem] sm:pl-16 sm:text-2xl text-md leading-tight text-white"
            style={stylesWithCssVar({
              opacity: endTextOpacity,
              "--y": endTexty,
            })}
          >
         <span className="text-primary">Bloom with Purpose</span>
          <br />

          Bloom nurtures genuine connections and personal growth digitally.
          </motion.p>
        </div>
        <motion.p
          style={stylesWithCssVar({
          ...
          className="translate-y-centered-offset top-1/2 left-[20px] w-[300px] pl-16 sm:text-2xl text-md leading-tight text-white"
        >
          Not only scroll,
         
          <br />
          <span className="text-primary">Elevate your feed.</span>
        </motion.p>
        <motion.p
          style={stylesWithCssVar({
          ...
          className="translate-y-centered-offset top-1/2 right-[20px] w-[300px] pr-16 sm:text-2xl text-md leading-tight text-white"
        >
          Not only share content,
          <br />
